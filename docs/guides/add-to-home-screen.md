...
This is the recommended way to add an app to your Home Screen. It launches the app directly without opening LiveContainer’s UI first, and it automatically finds a free LiveContainer to open the app. This saves about 1.5–3 seconds per launch compared to the other methods below.
...
15. To add more apps to your home screen, hold your shortcut, tap "Duplicate," and edit the Launch URL to another app’s URL.
<p>
